...
The application is a single-file executable (`app/Main.hs`) with a simple pipeline:
...
The codebase contains two implementations of the inversion logic:
- `invertConfigMap`: Original fold-based implementation
- `invertConfigMapLens`: Lens-based implementation using Control.Lens (currently in use)
